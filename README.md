...
3.1 Caracterizar o perfil sociodemográfico;
3.2 Identificar indicadores relacionados à demanda de cuidados;
3.3 Analisar a distribuição da demanda associada às DCNTs;
3.4 Caracterizar a provisão de cuidados;
3.5 Comparar RN, NE e Brasil;
3.6 Identificar possíveis diferenças entre demanda e provisão.
